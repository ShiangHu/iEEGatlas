...
%                      uicontrols and mesh objectsope
...
if isequal(texture,'none')
    ...
    if isequal(length(texture),length(m.vertices))
        ...
        udd.tex = texture;
%         ParentAxes.CLim = options.CLim; % added by ah
...
% % Transparancy sliders                   % commented by ah
% pos = [20 100 20 245];
% pos(1) = pos(1) + ns.*25;
...
% % Texture thresholding sliders             % commented by ah
